...
public interface ControlFlowStatements2{
	...
	*/
	 ...
	 * превысит 200 км (целое число), и сам суммарный пробег (вещественное число).
	 ...
	 * ВОПРОС: как можно было бы обойтись без специального типа, изменив сигнатуру метода calculateProbeg?
	 */
